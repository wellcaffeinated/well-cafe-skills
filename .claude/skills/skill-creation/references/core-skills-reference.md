---
name: core-skills-reference
description: Official Claude Code skills documentation — full reference for SKILL.md structure, frontmatter, string substitutions (${CLAUDE_SKILL_DIR}, $ARGUMENTS, etc.), supporting files, invocation control, subagents, allowed-tools, and plugin packaging.
source: https://code.claude.com/docs/en/skills.md
---

# Claude Code Skills — Official Reference

Full official documentation. Read this when you need authoritative detail on any skills feature not covered inline in SKILL.md.

## Table of contents

- [Getting started](#getting-started) — create a skill, where skills live, auto-discovery
- [Configure skills](#configure-skills) — types of content, frontmatter reference
- [Frontmatter reference](#frontmatter-reference) — all frontmatter fields
- [String substitutions](#available-string-substitutions) — `${CLAUDE_SKILL_DIR}`, `$ARGUMENTS`, `$0`, `$name`, etc.
- [Supporting files](#add-supporting-files) — scripts/, references/, assets/
- [Invocation control](#control-who-invokes-a-skill) — user-invocable, Claude-only
- [Pass arguments](#pass-arguments-to-skills) — arguments frontmatter, named args
- [Inject dynamic context](#inject-dynamic-context) — bash injection, live values
- [Run in subagent](#run-skills-in-a-subagent) — subagent execution pattern
- [Pre-approve tools](#pre-approve-tools-for-a-skill) — allowed-tools per skill
- [Evaluate and iterate](#evaluate-and-iterate-on-a-skill) — skill-creator evals
- [Share skills / plugins](#share-skills) — packaging and distribution
- [Troubleshooting](#troubleshooting) — not triggering, triggers too often
